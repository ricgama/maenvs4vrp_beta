...
class Observations(ObservationBuilder):
    ...
    POSSIBLE_OTHER_AGENTS_FEATURES = ['x_coordinate_min_max', 'y_coordinate_min_max', 'frac_current_time', 
                                    ...
                                    'dist2agent_div_end_time', 'frac_feasible_nodes']
    ...
    def get_feat_agent_frac_current_load(self):
        ...
        Returns: 
            int: agent fraction of used capacity.
        """
    ...
    def get_feat_agents_frac_current_load(self):
        ...
        Returns: 
            npt.NDArray: agents fraction of used capacity.
        """
    ...
    def get_feat_global_frac_demands(self):
        ...
        Returns: 
            int: fraction of served demands
        """
    ...
    def get_feat_global_frac_fleet_load_capacity(self):
        ...
        Returns: 
            int: fraction of fleet load capacity
        """
