...
class Observations(ObservationBuilder):
    ...
    POSSIBLE_NODES_STATIC_FEATURES = ['x_coordinate', 'y_coordinate', 'tw_low',
                                    'tw_high', 'linehaul_demand', 'backhaul_demand', 'service_times', 'tw_high_minus_tw_low_div_max_dur',
    ...
    POSSIBLE_AGENT_FEATURES = ['x_coordinate', 'y_coordinate','x_coordinate_min_max', 'y_coordinate_min_max', 'frac_current_time', 
                                ...
                                'remaining_dist', 'frac_feasible_nodes']
    ...
    def __init__(self, feature_list:Dict = None):
        ...
        self.default_feature_list = {'nodes_static': {'x_coordinate': {'feat': 'x_coordinate', 'norm': None},
                                        ...
                                        'service_times': {'feat': 'service_times', 'norm': 'min_max'},
                                    ...
                                    'global': ['frac_linehaul_demands', 'frac_backhaul_demands', 'frac_done_agents', 'open_routes']}
    ...
    ### Inicio das funçoes novas


    


    ### Fim das funçoes novas
    ...
    def get_feat_service_times(self):
        """
        Nodes service time.
        ...
        """
        return self.env.td_state['service_times']
    ...
    def get_feat_agent_remaining_dist(self):
        ...
        reamining_dist = torch.nan_to_num(remaining_dist, posinf=0.0, neginf=0.0, nan=0.0)
